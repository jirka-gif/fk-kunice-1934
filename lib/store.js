...
import { DEFAULTS, mergeStored, clone, emptyNextMatch, emptyMatchDetail, emptyLastMatch, emptyCamp, emptyNews, slugify, emptyOpponent, opponentKey, collectOpponentNames, cleanClubName, emptySponsor, emptyGalleryItem } from '@/lib/defaults';

const KEY = 'fk-cms-cache-v2';

// re-export pro zpětnou kompatibilitu
export { emptyNextMatch, emptyMatchDetail, emptyLastMatch, emptyCamp, emptyNews, slugify, emptyOpponent, opponentKey, collectOpponentNames, cleanClubName, emptySponsor, emptyGalleryItem, DEFAULTS };
