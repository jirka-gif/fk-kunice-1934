...
import { DEFAULTS, mergeStored, clone, emptyNextMatch, emptyMatchDetail, emptyLastMatch, emptyCamp, emptyNews, slugify } from '@/lib/defaults';

const KEY = 'fk-cms-cache-v2';

// re-export pro zpětnou kompatibilitu
export { emptyNextMatch, emptyMatchDetail, emptyLastMatch, emptyCamp, emptyNews, slugify, DEFAULTS };
...
function scheduleServerSave() {
  ...
  _saveTimer = setTimeout(async () => {
    try {
      ...
      // ticho — offline změna zůstane v mezipaměti a odešle se při další úpravě
