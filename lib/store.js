...
function teamMatch(id) {
  if (id === 'muziA') return {
    nextMatch: { ...club.nextMatch, dateISO: '2026-06-28T16:30' },
  ...
  if (id === 'zaciU15') return {
    nextMatch: { home: { short: 'FK', name: 'KUNICE', side: 'Domácí' }, away: { short: 'MU', name: 'MUKAŘOV', side: 'Hosté' }, when: 'SO 10:00 · OKRESNÍ PŘEBOR', venue: 'Areál Kunice', dateISO: '2026-06-27T10:00' },
