...
import { DEFAULTS, mergeStored, clone, emptyNextMatch, emptyMatchDetail, emptyLastMatch } from '@/lib/defaults';

const KEY = 'fk-cms-cache-v2';

// re-export pro zpětnou kompatibilitu
export { emptyNextMatch, emptyMatchDetail, emptyLastMatch, DEFAULTS };
