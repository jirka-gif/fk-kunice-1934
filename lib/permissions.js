...
export const ADMIN_SECTIONS = [
  ...
  { id: 'zaznam', label: 'Záznam změn', icon: 'dashboard' },
...
export const ADMIN_GROUPS = [
  ...
  { id: 'hriste', label: 'Zápasy', icon: 'ball', sections: ['zapasy'] },
  ...
  // Vzhled a obsah stránek: fotky, soupisky týmů, partneři, kontakt a dlaždice.
  // Týmy sem patří k ostatnímu obsahu webu; u zápasů zůstaly jen zápasy.
  { id: 'web', label: 'Stránky a média', icon: 'partners', sections: ['domu', 'tymy', 'partneri', 'kontakt'] },
  // Sociální sítě jsou samostatná agenda (fronta příspěvků), ne nastavení —
  // proto vlastní položka v menu.
  { id: 'socialni', label: 'Sociální sítě', icon: 'partners', sections: ['socialni'] },
  // Uživatelé a role jsou první: do Nastavení se chodí hlavně kvůli nim.
  { id: 'nastaveni', label: 'Nastavení', icon: 'settings', sections: ['uzivatele', 'nastaveni'] },
  // Vidí ji jen Super správce — ostatní role na sekci `zaznam` právo nemají.
  { id: 'zaznam', label: 'Záznam změn', icon: 'dashboard', sections: ['zaznam'] },
];
...
export const SECTION_CONTENT_KEYS = {
  domu: ['homeTexts', 'pageTexts', 'footer', 'whyCards', 'gallery'],
  tymy: ['teams'],
...
// Role Super správce vidí navíc záznam změn a přihlášení. Přidělit ji smí jen
// ten, kdo ji sám má — kontroluje to server v /api/users, ne jen rozhraní.
export const SUPER_ROLE = 'superspravce';
  ...
  return [
    {
      id: SUPER_ROLE,
      name: 'Super správce',
      description: 'Vše jako Správce a navíc záznam změn a přihlášení.',
    ...
    },
    {
      id: 'spravce',
      name: 'Správce',
      description: 'Plný přístup ke správě webu. Záznam změn nevidí.',
      system: true,
      // Jediný rozdíl proti Super správci — proto se dopisuje výslovně tady
      // i v lib/users.js, kde se systémovým rolím práva vynucují.
      permissions: { ...allEdit(), zaznam: 'none' },
    },
    {
      id: 'redaktor',
      name: 'Redaktor',
