...
export const ADMIN_SECTIONS = [
  ...
  { id: 'domu', label: 'Domů / texty', icon: 'news' },
  ...
  { id: 'registrace', label: 'Registrace', icon: 'userplus' },
...
export const SECTION_CONTENT_KEYS = {
  domu: ['homeTexts', 'footer', 'whyCards'],
  tymy: ['teams'],
  zapasy: ['teams', 'matchProposals', 'matchesSync'],
  novinky: ['news'],
  kempy: ['camps'],
  pronajem: ['rentalPlans', 'rentalBusyDays', 'rentalFaq', 'reservations', 'facilities'],
  ...
  return [
    ...
    },
    {
      ...
      permissions: normalizePermissions({
        ...
        zpravy: 'view', partneri: 'view', registrace: 'none', nastaveni: 'none', uzivatele: 'none',
      }),
    },
    {
      id: 'trener',
      ...
      permissions: normalizePermissions({
        ...
        zpravy: 'none', partneri: 'none', registrace: 'view', nastaveni: 'none', uzivatele: 'none',
      }),
    },
    {
      id: 'sekretariat',
      ...
      permissions: normalizePermissions({
        ...
        zpravy: 'edit', partneri: 'view', registrace: 'edit', nastaveni: 'none', uzivatele: 'none',
      }),
    },
  ];
}
