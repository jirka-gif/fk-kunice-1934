...
export function useRevealEngine() {
  useEffect(() => {
    ...
    function updateCountdown() {
      ...
      // kemp — cílové datum si stránka řekne přes atribut data-camp-start
      const campEl = document.querySelector('[data-camp-start]');
      const campISO = (campEl && campEl.getAttribute('data-camp-start')) || '';
      const camp = new Date(campISO || '2026-07-07T08:00:00');
      if (isNaN(camp)) return;
